...
//                new User(0L, "QRillich", "password111", "Кирилл", "lastname", "email", "0", -1000, User.Sex.MALE, Set.of(admin, test),null,null),
//                new User(0L, "KensynHimura", "Pa$$w0rd!#!", "Аркадий", "lastname", "email", "", 20000, User.Sex.MALE, Set.of(admin, user),null,null),
//                new User(0L, "smoke9890", "Will-molecule-manciple-rib-fiducial-alum-pierce-hierarch-coachman-squadron-canvas-commune-minstrel-poky-airspace", "Павел", "lastname", "email", "не скажу", 18, User.Sex.MALE, Set.of(admin),null,null),
//                new User(0L, "Tema41", "password41", "Артем", "lastname", "email", "123", 18, User.Sex.MALE, Set.of(user, test),null,null),
//                new User(0L, "ws-eliseev", "password☺/☻/–", "Александр", "lastname", "email", "345476", 1, User.Sex.MALE, null,null,null),
//                new User(0L, "YaSlawaMarlow", "", "Артём", "lastname", "email", "+79273777777'); DROP TABLE USERS;--", 0, User.Sex.MALE, Set.of(admin),null,null));
